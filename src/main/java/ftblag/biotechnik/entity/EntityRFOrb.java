...
public class EntityRFOrb extends Entity implements IEntityAdditionalSpawnData  {
    ...
    public EntityRFOrb(SpawnEntity packet, Level world) {
        this(BTRegistry.ORB_TYPE.get(), world);
    }
    ...
    public void tick() {
        ...
        if (this.closestPlayer != null && (this.closestPlayer.isSpectator() || this.closestPlayer.isDeadOrDying())) {
   ...
   protected BlockPos getBlockPosBelowThatAffectsMyMovement() {
    ...
    public void readSpawnData(FriendlyByteBuf additionalData) {
        this.rfValue = additionalData.readShort();
    }

    @Override
    public void writeSpawnData(FriendlyByteBuf buffer) {
        buffer.writeShort(this.rfValue);
    }
