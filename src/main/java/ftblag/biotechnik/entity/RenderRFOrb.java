...
public class RenderRFOrb extends EntityRenderer<EntityRFOrb> {
    ...
    public RenderRFOrb(EntityRendererProvider.Context context) {
        super(context);
    ...
    @Override
    public void render(EntityRFOrb orb, float p_225623_2_, float p_225623_3_, PoseStack stack, MultiBufferSource buffer, int p_225623_6_) {
        stack.pushPose();
    ...
    private static void vertex(VertexConsumer builder, Matrix4f matrix4f, Matrix3f matrix3f, float x, float y, int r, int g, int b, float u, float v, int uv2) {
        builder
